...
export const workspaceGroups: WorkspaceGroup[] = [
  ...
  },
  {
    ...
    surfaces: [
      ...
      { id: 'workspace-feedback-hub', label: 'Feedback hub', description: 'Builds a local privacy-checked draft and keeps public sharing behind responsible-adult review.', effect: 'clipboard-optional' },
    ],
  },
  {
    id: 'reference',
