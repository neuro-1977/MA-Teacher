export const stageLenses = [
  {
    ...
    learnerCue: 'Ask a trusted adult to read this with you. Pick one tiny part. You can point, move, draw or say your answer.',
  ...
  },
  {
    ...
    learnerCue: 'Do one small part at a time. You can use objects, pictures, talk or a short answer.',
  ...
  },
  {
    ...
    learnerCue: 'Try the activity, then use one clear example to explain your thinking.',
  ...
  },
  {
    ...
    learnerCue: 'Use subject words and show the evidence or steps behind your answer.',
  ...
  },
  {
    ...
    learnerCue: 'Connect your answer to evidence, method or reasoning. Check what the task really asks.',
  ...
  },
  {
    ...
    learnerCue: 'Adapt the example to your goal. Choose a respectful format that clearly shows what you can do.',
